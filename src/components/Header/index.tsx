  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-30 w-full border-b border-gray-300 bg-white px-5 py-3 dark:bg-gray-500">
      ...
      <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between gap-4">
        <Logo className="z-50" />
        <nav
          className={`fixed top-0 z-40 flex h-full w-full flex-col items-center justify-center bg-white transition-all duration-300 dark:bg-gray-500 lg:static lg:flex-[1_1_auto] lg:flex-row lg:justify-between lg:bg-transparent lg:transition-none dark:lg:bg-transparent ${isMenuOpen ? "pointer-events-auto visible left-0" : "pointer-events-none invisible left-[100%] lg:pointer-events-auto lg:visible"}`}
        >
